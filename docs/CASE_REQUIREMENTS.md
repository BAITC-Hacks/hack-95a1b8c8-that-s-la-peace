# Исходное ТЗ кейса #79-lite

Источник: предоставленный пользователем DOCX «HackAlem AI_ Хакатон-задача_ умный подбор подрядчиков.docx», получен 23.09.2026. Ниже текст русской части; табличное форматирование преобразовано в последовательный текст. Это источник требований, а не отчёт об их выполнении. Дополнительные прямые объявления организаторов сверяет капитан.
