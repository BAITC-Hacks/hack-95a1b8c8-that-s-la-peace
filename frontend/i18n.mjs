...
const phrases = {
  ...
  'Число — свободные профили выбранной услуги; бюджет, язык и часы не учтены. Даты с 0 тоже можно выбрать.': ['Сан — таңдалған қызметтің бос профильдері; бюджет, тіл және сағаттар ескерілмейді. 0 көрсетілген күндерді де таңдауға болады.', 'Counts are available profiles for this service, before budget, language and hours. Dates with 0 are selectable too.'],
  'Время бронирований в каталоге не указано.': ['Каталогта брондау уақыты көрсетілмеген.', 'Booking times are not provided in the catalog.'],
  ...
  'Почему подходит': ['Неліктен сәйкес келеді', 'Why it fits'],
  'начальная цена по каталогу': ['каталогтағы бастапқы баға', 'starting catalog price'],
  'Посмотреть результат': ['Нәтижені көру', 'View results'],
